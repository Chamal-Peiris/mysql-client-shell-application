...
public class MainUIController {
    ...
    public void btnExecute_OnAction(ActionEvent actionEvent) {
        String statement = txtSqlCommand.getText();

        if (!txtSqlCommand.getText().endsWith(";")) {
            statement += ";";
        }
    ...
    private void processInputStream(InputStream is) throws IOException {
                ...
                while (true) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        if (txtOutput.getText().contentEquals("Enter password: ")){
                            txtOutput.clear();
                            txtOutput.setText("Welcome to Chamal Peiris's SQL Client Shell Application\n");
                        }
                    });
                }
            } catch (IOException e) {
